...
<head>
    ...
    <link rel="shortcut icon" href="assets/img/family.jpg" type="image/x-icon">
    <meta name="description" content="The Family Plan">


    <title>STORYTIME | BOOKING : The Family Plan</title>
...
<body>
    ...
    <section data-bs-version="5.1" class="header2 cid-tvxGDt9 mbr-parallax-background" id="header2-2n">
        ...
        <div class="container">
            <div class="row">
                <div class="col-12 col-lg-7">
                    <h1 class="mbr-section-title mbr-fonts-style mb-3 display-1"><strong>The Family Plan</strong></h1>

                    <p class="mbr-text mbr-fonts-style display-7">Dan Morgan is many things: a devoted husband, a loving father, a celebrated car salesman. He's also a former assassin. And when his past catches up to his present, he's forced to take his unsuspecting family on a road trip unlike any other.</p>
                    <div class="mbr-section-btn mt-3"><a class="btn btn-secondary display-4"
                            href="">Book Now</a>
                        <a class="btn btn-primary-outline display-4"
                            href="https://www.youtube.com/watch?v=ns8weNznn1Y">Trailer &gt;</a>
                    </div>
                </div>
            </div>
        </div>
