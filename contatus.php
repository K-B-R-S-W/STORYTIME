...
<head>
    ...
    <title>STORYTIME | CONTACT US</title>
...
<body>
        ...
        <nav class="navbar navbar-dropdown navbar-fixed-top navbar-expand-lg">
            <div class="container-fluid">
                <div class="navbar-brand">
                    ...
                    <span class="navbar-caption-wrap"><a class="navbar-caption text-white text-primary display-5" href="index.php">STORYTIME</a></span>
                </div>
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav nav-dropdown" data-app-modern-menu="true">
                        ...
                        <li class="nav-item"><a class="nav-link link text-white text-primary display-4" href="contatus.php">Contact Us</a></li>
                        <li class="nav-item"><a class="nav-link link text-white text-primary display-4" href="aboutus.php">About Us</a></li>
                    </ul>
    ...
    <section data-bs-version="5.1" class="form1 cid-trttypvPc9 mbr-fullscreen mbr-parallax-background" id="form1-16">
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-lg-8 mx-auto mbr-form" data-form-type="formoid">
                <form action="" method="POST" class="mbr-form form-with-styler" data-form-title="Form Name">
                    <input type="hidden" name="email" data-form-email="true" value="sUIL3ndKedAAtRvfd5lxGv/PiP88/BubbtBUiapBABj1jVAUCMrnKBhHez7IUAaeITxD4M+N7FVE5wbMazuaRmWQwYHuuXFZtCuDmOweUXyWqvjB+0b1UFcSA38V9jqQ">
                    <div class="row">
                        <div hidden="hidden" data-form-alert="" class="alert alert-success col-12">Yayy! Subscription Added!</div>
                        <div hidden="hidden" data-form-alert-danger="" class="alert alert-danger col-12">Oops...! some problem!</div>
                    </div>
                    <div class="dragArea row">
                        <div class="col-12">
                            <h1 class="mbr-section-title mb-4 mbr-fonts-style align-center display-2">
                                <strong>Get Latest Storytime Updates!</strong>
                            </h1>
                        </div>
                        <div class="col-12">
                            <p class="colo mbr-fonts-style mb-5 align-center display-7"><strong>By completing this form, you will be able to receive reminders about upcoming movie screenings at Storytime. Be the first to reserve a seat!</strong></p>
                        </div>
                        <div class="">
                            <label for="name" class="signup-label"></label>
                            <input type="name" class="form-control" id="name" name="Name" placeholder="NAME : John Wick" autocomplete="on">
                        </div>
                        <div class="">
                            <label for="email" class="signup-label"></label>
                            <input type="email" class="form-control" id="email" name="Email" placeholder="EMAIL : abc@gmail.com" autocomplete="off">
                        </div>
                        <div class="">
                            <label for="description" class="signup-label"></label>
                            <input type="text" class="form-control" id="description" name="Description" placeholder="DESCRIPTION : Hella good service">
                        </div>
                        <div class="">
                            <label for="phone-number" class="signup-label"></label>
                            <input type="number" class="form-control" id="phone-number" name="Phonenumber" placeholder="PHONE-NUMBER : +94 123456789">
                        </div>
    ...
    <section data-bs-version="5.1" class="contacts3 map1 cid-trtrvSFFDZ" id="contacts3-14">
                ...
                <div class="card col-12 col-md-6">
                    <div class="card-wrapper">
                        ...
                        <div class="text-wrapper">
                            ...
                            <p class="mbr-text mbr-fonts-style display-7"><a href="tel:0115445000" class="text-primary">0112 100 500</a></p>
                        </div>
                    </div>
                    <div class="card-wrapper">
                        <div class="image-wrapper">
                            <a href="https://mail.google.com/mail/?view=cm&fs=1&to=sltcresearch@gmail.com&su=Generated_From_Storytime/"><span class="mbr-iconfont socicon-mail socicon"></span></a>
                        </div>
                        <div class="text-wrapper">
                            <h6 class="card-title mbr-fonts-style mb-1 display-5">
                                <strong>Email</strong>
                            </h6>
                            <p class="mbr-text mbr-fonts-style display-7"><a href="mailto:sltcresearch@gmail.com
                                " class="text-primary">sltcresearch@gmail.com
                                </a></p>
                        </div>
                    </div>
                </div>
                <div class="map-wrapper col-12 col-md-6">
                    <div class="google-map"><iframe frameborder="0" style="border:0" src="https://www.google.com/maps/embed/v1/place?key=AIzaSyDk89J4FSunMF33ruMVWJaJht_Ro0kvoXs&amp;q=SLTC Research University · Ingiriya Road, Padukka, Sri Lanka" allowfullscreen=""></iframe></div>
                </div>
            </div>
        </div>
    </section>

    <section data-bs-version="5.1" class="content17 cid-trwVfbJWlC" id="content17-23">
                    ...
                    <div id="bootstrap-toggle" class="toggle-panel accordionStyles tab-content">
                        <div class="card mb-3">
                            <div class="card-header" role="tab" id="headingOne">
                                <a role="button" class="collapsed panel-title text-black" data-toggle="collapse" data-bs-toggle="collapse" data-core="" href="#collapse1_35" aria-expanded="false" aria-controls="collapse1">
                        ...
                        <div class="card mb-3">
                            <div class="card-header" role="tab" id="headingTwo">
                                <a role="button" class="collapsed panel-title text-black" data-toggle="collapse" data-bs-toggle="collapse" data-core="" href="#collapse2_35" aria-expanded="false" aria-controls="collapse2">
                        ...
                        <div class="card mb-3">
                            <div class="card-header" role="tab" id="headingThree">
                                <a role="button" class="collapsed panel-title text-black" data-toggle="collapse" data-bs-toggle="collapse" data-core="" href="#collapse3_35" aria-expanded="false" aria-controls="collapse3">
                        ...
                        <div class="card mb-3">
                            <div class="card-header" role="tab" id="headingThree">
                                <a role="button" class="collapsed panel-title text-black" data-toggle="collapse" data-bs-toggle="collapse" data-core="" href="#collapse4_35" aria-expanded="false" aria-controls="collapse4">
    ...
    <section data-bs-version="5.1" class="mbr-section mbr-section--no-padding cid-VI1mvbLtsj" id="design-block-VI1mvbLtsj">
        ...
        <svg width="100%" height="50px" preserveAspectRatio="none" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 1920 75">
            <path class="wave1" d="M1963,327H-105V65A2647.49,2647.49,0,0,1,431,19c217.7,3.5,239.6,30.8,470,36,297.3,6.7,367.5-36.2,642-28a2511.41,2511.41,0,0,1,420,48">
            </path>
            <path class="wave2" d="M-127,404H1963V44c-140.1-28-343.3-46.7-566,22-75.5,23.3-118.5,45.9-162,64-48.6,20.2-404.7,128-784,0C355.2,97.7,341.6,78.3,235,50,86.6,10.6-41.8,6.9-127,10">
            </path>
            <path class="wave3" d="M1979,462-155,446V106C251.8,20.2,576.6,15.9,805,30c167.4,10.3,322.3,32.9,680,56,207,13.4,378,20.3,494,24">
            </path>
            <path class="wave4" d="M1998,484H-243V100c445.8,26.8,794.2-4.1,1035-39,141-20.4,231.1-40.1,378-45,349.6-11.6,636.7,73.8,828,150">
            </path>
        </svg>
    ...
    <section data-bs-version="5.1" class="_customHTML cid-trtriAFRMT" id="design-block-13">
    ...
    <section data-bs-version="5.1" class="_customHTML cid-FIStZ0CPEN" id="design-block-FIStZ0CPEN">



    <!--<div class="email">
    <a href="https://mail.google.com/mail/?view=cm&fs=1&to=gsahindu@gmail.com&su=Generated_From_Storytime" class="float" data-toggle="modal" data-bs-toggle="modal" data-target="#mbr-popup-1y" data-bs-target="#mbr-popup-1y" target="_blank">
        <span class="my-float socicon-mail socicon"></span>
    </a>
</div>-->
