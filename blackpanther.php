...
<head>
    ...
    <link rel="shortcut icon" href="assets/images/1a1f71a9-00ea-40ea-9b55-2556294a84d4-1-450x600.jpg" type="image/x-icon">
    <meta name="description" content="BLACKPANATHER">


    <title>STORYTIME | BOOKING : BLACKPANATHER</title>
...
<body>
    ...
    <section data-bs-version="5.1" class="header2 cid-tvxGDtetH9 mbr-parallax-background" id="header2-2n">
        ...
        <div class="container">
            <div class="row">
                <div class="col-12 col-lg-7">
                    <h1 class="mbr-section-title mbr-fonts-style mb-3 display-1"><strong>Black Panther</strong></h1>

                    <p class="mbr-text mbr-fonts-style display-7">After his father's death, T'Challa returns home to
                        Wakanda to inherit his throne. However, a powerful enemy related to his family threatens to
                        attack his nation.</p>
                    <div class="mbr-section-btn mt-3"><a class="btn btn-secondary display-4"
                            href="">Book Now</a>
                        <a class="btn btn-primary-outline display-4"
                            href="https://www.youtube.com/watch?v=_Z3QKkl1WyM">Trailer &gt;</a>
                    </div>
                </div>
            </div>
        </div>
