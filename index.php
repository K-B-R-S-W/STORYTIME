...
<head>
    ...
    <meta name="generator" content="STORYTIME">
    <meta name="viewport" content="width=device-width, initial-scale=1, minimum-scale=1">
    <link rel="shortcut icon" href="assets/images/pngwing.com-2-616x516.png" type="image/x-icon">
    <meta name="description" content="Book your tickets now!">


    <title>STORYTIME | HOME</title>
    <link rel="stylesheet" href="assets/web/assets/icons2/new.css">
   ...
   <link rel="stylesheet" href="ripple/ripple.css" >
    ...
    <link rel="preload"
        href="https://fonts.googleapis.com/css?family=M+PLUS+Rounded+1c:100,300,400,500,700,800,900&display=swap"
        as="style" onload="this.onload=null;this.rel='stylesheet'">
    <noscript>
        <link rel="stylesheet"
            href="https://fonts.googleapis.com/css?family=M+PLUS+Rounded+1c:100,300,400,500,700,800,900&display=swap">
    </noscript>
    <link rel="preload" as="style" href="assets/add/css/mbr-additional.css">
    <link rel="stylesheet" href="assets/add/css/mbr-additional.css" type="text/css">
...
<body oncontextmenu="return false">
            ...
            <div class="container-fluid">
                <div class="navbar-brand">
                    ...
                    <span class="navbar-caption-wrap"><a class="navbar-caption text-white display-5"
                            href="index.php">STORYTIME</a></span>
                </div>
    ...
    <section data-bs-version="5.1" class="cid-C76tvlGSd5 mbr-fullscreen mbr-parallax-background"
        id="design-block-C76tvlGSd5">
        ...
        <div class="container">
            <div class="media-container-row d-flex align-items-center">
                <div class="mbr-white col-12 col-lg-6 text-center text-lg-left py-5">
                    ...
                    <div class=" cid-trpEKMvXPD  ">

                        <h1 class="ditext  mbr-section-title mbr-fonts-style pb-2 reveal display-1">
                            <strong>Amazing<span>STORYTIME</span> Deals</strong>
                        </h1>
                      
                    </div>
                  <div class="pitext">
                    <h1 class="mbr-section-title pb-2 mbr-fonts-style display-1"><strong>STORYTIME</strong></h1>
                <p class="mbr-text pb-4 mbr-fonts-style wrapper display-5">
                    Book Your Tickets Now
                </p>
                  </div>
                    <div class="pad">
                        <div class=" mbr-section-btn"><a class="ripple-click btn btn-md btn-secondary display-4"
                                href="Movies.php">Buy Tickets</a>
                            <a class="ripple-hover  btn btn-md btn-black display-4" href="#up">Explore &gt;</a>
                        </div>
                    </div>
                </div>
                <div class="col-8 col-lg-5 mx-auto py-5">
                    <img src="assets/images/pngwing.com-2-616x516.png" class="img-fluid" alt="" title="">
                </div>
            </div>
        </div>
        <div class="mbr-arrow hidden-sm-down" aria-hidden="true">
            <a href="#next">
                <span class="fa-chevron-down fa mobi-mbri-arrow-down mobi-mbri"></span>
            </a>
        </div>
    </section>

    <section data-bs-version="5.1" class="slider1 cid-trorAjdlQF" id="slider1-n">

        <div class="carousel slide carousel-fade" id="trxa16Egef" data-ride="carousel" data-bs-ride="carousel"
            data-interval="5000" data-bs-interval="5000">
            <ol class="carousel-indicators">
                <li data-slide-to="0" data-bs-slide-to="0" class="active" data-target="#trxa16Egef"
                    data-bs-target="#trxa16Egef"></li>
                <li data-slide-to="1" data-bs-slide-to="1" data-target="#trxa16Egef" data-bs-target="#trxa16Egef"></li>
                <li data-slide-to="2" data-bs-slide-to="2" data-target="#trxa16Egef" data-bs-target="#trxa16Egef"></li>
            </ol>
            <div class="carousel-inner">

                <div class="carousel-item slider-image item active">
                    <div class="item-wrapper">
                        <img class="d-block w-100" src="assets/images/ef141bf5-da47-476e-9011-d3e794b598c7-1500x731.png"
                            alt="Wekanada" data-slide-to="0" data-bs-slide-to="0">

                        <div class="carousel-caption">
                            <h5 class="mbr-section-subtitle mbr-fonts-style display-5"><strong>BLACK PANTHER: WAKANDA
                                    FOREVER</strong></h5>
                            <p class="mbr-section-text mbr-fonts-style display-7">2022 ‧ Action/Adventure</p>
                        </div>
                    </div>
                </div>
                <div class="carousel-item slider-image item">
                    <div class="item-wrapper">
                        <img class="d-block w-100" src="assets/images/3abf272c-dfe8-402f-94fe-d8be8206dfa8-1500x730.jpg"
                            alt="Avatar" data-slide-to="1" data-bs-slide-to="1">

                        <div class="carousel-caption">
                            <h5 class="mbr-section-subtitle mbr-fonts-style display-5"><strong>Avatar: The Way of
                                    Water</strong></h5>
                            <p class="mbr-section-text mbr-fonts-style display-7">2022 ‧ Sci-fi/Action</p>
                        </div>
                    </div>
                </div>
                <div class="carousel-item slider-image item">
                    <div class="item-wrapper">
                        <img class="d-block w-100" src="assets/images/stretched-1920-1080-1274206-1900x1069.jpg"
                            alt="BlackAdam" data-slide-to="2" data-bs-slide-to="2">

                        <div class="carousel-caption">
                            <h5 class="mbr-section-subtitle mbr-fonts-style display-5"><strong>Black Adam</strong></h5>
                            <p class="mbr-section-text mbr-fonts-style display-7">2022 ‧ Action/Adventure</p>
                        </div>
                    </div>
                </div>
    ...
    <section data-bs-version="5.1" class="slider5 mbr-embla cid-tros1i5bnL mbr-parallax-background" id="slider5-s">
        <div id="up">
        ...
        <div class="position-relative">
            ...
            <div class="embla mt-4" data-skip-snaps="true" data-align="center" data-contain-scroll="trimSnaps"
                data-loop="true" data-auto-play="true" data-auto-play-interval="10" data-draggable="true">
                    ...
                    <div class="embla__container">
                        <div class="embla__slide slider-image item active"
                            ...
                            <div class="slide-content">
                                <div class="item-img">
                                    <div class="item-wrapper">
                                        <img src="assets/images/Chicken_Run_Dawn_of_the_Nugget-981881616-large.jpg"
                                            alt="ChickenRun" title="">
                                    </div>
                                </div>
                                <div class="item-content">
                                    <h5 class="item-title mbr-fonts-style display-5">
                                        <strong>Chicken Run:</strong><br><strong> Dawn of the Nugget</strong>
                                    </h5>
                                    <h6 class="item-subtitle mbr-fonts-style mt-1 display-7">NOW SHOWING</h6>

                                </div>
                                <div class="mbr-section-btn item-footer mt-2"><a href="chickenrun.php"
                                        class="btn item-btn btn-black display-7" target="_blank"><span
                                            class="ripple-hover  mobi-mbri mobi-mbri-right mbr-iconfont mbr-iconfont-btn"></span>Book
                                        Now</a></div>
                            </div>
                        </div>
                        <div class="embla__slide slider-image item" style="margin-left: 3rem; margin-right: 3rem;">
                            <div class="slide-content">
                                <div class="item-img">
                                    <div class="item-wrapper">
                                        <img src="assets/img/3aij5sA5AhK2flrjsfrVQs93CUx.jpg"
                                            alt="black adam" title="" data-slide-to="1" data-bs-slide-to="1">
                                    </div>
                                </div>
                                <div class="item-content">
                                    <h5 class="item-title mbr-fonts-style display-5"><strong>Barbie</strong></h5>
                                    <h6 class="item-subtitle mbr-fonts-style mt-1 display-7">NOW SHOWING</h6>

                                </div>
                                <div class="mbr-section-btn item-footer mt-2"><a href="barbie.php"
                                        class="btn item-btn btn-black display-7" target="_blank"><span
                                            class="ripple-hover mobi-mbri mobi-mbri-right mbr-iconfont mbr-iconfont-btn"></span>Book
                                        Now</a></div>
                            </div>
                        ...
                        <div class="embla__slide slider-image item" style="margin-left: 3rem; margin-right: 3rem;">
                            <div class="slide-content">
                                <div class="item-img">
                                    <div class="item-wrapper">
                                        <img src="assets/img/8Gxv8gSFCU0XGDykEGv7zR1n2ua.jpg"
                                            alt="wakanda" title="" data-slide-to="2" data-bs-slide-to="2">
                                    </div>
                                </div>
                                <div class="item-content">
                                    <h5 class="item-title mbr-fonts-style display-5"><strong>Oppenheimer</strong></h5>
                                    <h6 class="item-subtitle mbr-fonts-style mt-1 display-7">NOW SHOWING</h6>

                                </div>
                                <div class="mbr-section-btn item-footer mt-2"><a href="oppenheimer.php"
                                        class="btn item-btn btn-black display-7" target="_blank"><span
                                            class="ripple-hover mobi-mbri mobi-mbri-right mbr-iconfont mbr-iconfont-btn"></span>Book
                                        Now&nbsp;</a></div>
                            </div>
                        ...
                        <div class="embla__slide slider-image item" style="margin-left: 3rem; margin-right: 3rem;">
                            <div class="slide-content">
                                ...
                                <div class="item-content">
                                    <h5 class="item-title mbr-fonts-style display-5"><strong>The Family Plan</strong</h5>
                                    <h6 class="item-subtitle mbr-fonts-style mt-1 display-7">NOW SHOWING</h6>

                                </div>
                                  <div class="mbr-section-btn item-footer mt-2"><a href="thefamilyplan.php"
                                        class="btn item-btn btn-black display-7" target="_blank"><span
                                       class="ripple-hover mobi-mbri mobi-mbri-right mbr-iconfont mbr-iconfont-btn"></span>Book
                              Now&nbsp;</a></div>
                            </div>
    ...
    <section data-bs-version="5.1" class="slider3 mbr-embla cid-trppQe5krC" id="slider3-w">
                    ...
                    <div class="embla__container">
                            ...
                            <div class="card-wrap">
                                <div class="item-wrapper position-relative">
                                    <div class="image-wrap">
                                        <img src="assets/images/d6eaac72-71cf-4de1-a578-67a23658942b-450x600.jpg"
                                            alt="Babylion" data-slide-to="0" data-bs-slide-to="0">
                                    </div>
                                </div>
                                <div class="content-wrap">
                                    <h5 class="mbr-section-title card-title mbr-fonts-style align-center m-0 display-5">
                                        <strong>BRAD PITT:</strong><br><strong>BABYLON</strong>
                                    </h5>
                                    <h6 class="mbr-role mbr-fonts-style align-center mb-3 display-4"><strong>In Cinemas
                                            3rd February&nbsp;</strong></h6>
                                        ...
                                        <div class="soc-item">
                                            ...
                                            <script>
                                                function openVideo() {
                                                    ...
                                                    videoContainer.innerHTML = '<iframe width="560" height="1080" src="https://www.youtube.com/embed/LwIZTjMSjyI" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>';
                                                }
                                            </script>
                                            <a href="#vid">
                                            <span onclick="openVideo()"
                                                class=" mbr-iconfont mobi-mbri-play mobi-mbri"></span>
                                            </a>
                                        </div>
                        ...
                        <div class="embla__slide slider-image item" style="margin-left: 0rem; margin-right: 0rem;">
                            <div class="card-wrap">
                                <div class="item-wrapper position-relative">
                                    <div class="image-wrap">
                                        <img src="assets/images/4a271c7a-3900-4d8c-9cd1-8318558544be-450x600.jpg"
                                            alt="Quantumania" data-slide-to="1" data-bs-slide-to="1">
                                    </div>
                                </div>
                                <div class="content-wrap">
                                    <h5 class="mbr-section-title card-title mbr-fonts-style align-center m-0 display-5">
                                        ANT MAN &amp; WASP QUANTUMANIA</h5>
                                    <h6 class="mbr-role mbr-fonts-style align-center mb-3 display-4"><strong>In Cinemas
                                            3rd February&nbsp;</strong></h6>
                                    ...
                                    <div class="social-row display-7">
                                        <div class="soc-item">
                                             <script>
                                                function openVideo1() {
                                                    var videoContainer = document.getElementById("video-container");
                                                    videoContainer.innerHTML = '<iframe width="560" height="1080" src="https://www.youtube.com/embed/ZlNFpri-Y40" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>';
                                                }
                                            </script>
                                            <a href="#vid">
                                            <span onclick="openVideo1()"
                                                class=" mbr-iconfont mobi-mbri-play mobi-mbri"></span>
                                            </a>
                                        </div>
                                        <div class="soc-item">
                        ...
                        <div class="embla__slide slider-image item" style="margin-left: 0rem; margin-right: 0rem;">
                            <div class="card-wrap">
                                <div class="item-wrapper position-relative">
                                    <div class="image-wrap">
                                        <img src="assets/images/c03aefa7-fede-46c9-b61c-516f34480cc3-450x600.jpg"
                                            alt="Shazam" data-slide-to="2" data-bs-slide-to="2">
                                    </div>
                                </div>
                                <div class="content-wrap">
                                    <h5 class="mbr-section-title card-title mbr-fonts-style align-center m-0 display-5">
                                        <strong>SHAZAM<br>FURY OF THE GODS</strong>
                                    </h5>
                                    <h6 class="mbr-role mbr-fonts-style align-center mb-3 display-4"><strong>In Cinemas
                                            17th March&nbsp;</strong></h6>
                                    ...
                                    <div class="social-row display-7">
                                        <div class="soc-item">
                                             <script>
                                                function openVideo2() {
                                                    var videoContainer = document.getElementById("video-container");
                                                    videoContainer.innerHTML = '<iframe width="560" height="1080" src="https://www.youtube.com/embed/Zi88i4CpHe4" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>';
                                                }
                                            </script>
                                            <a href="#vid">
                                            <span onclick="openVideo2()"
                                                class=" mbr-iconfont mobi-mbri-play mobi-mbri"></span>
                                            </a>
                                        </div>
                                        <div class="soc-item">
                        ...
                        <div class="embla__slide slider-image item" style="margin-left: 0rem; margin-right: 0rem;">
                            <div class="card-wrap">
                                <div class="item-wrapper position-relative">
                                    <div class="image-wrap">
                                        <img src="assets/images/71b141af-998b-4a24-8645-b00b6cefc6da-450x600.jpg"
                                            alt="Shazam" data-slide-to="3" data-bs-slide-to="3">
                                    </div>
                                </div>
                                <div class="content-wrap">
                                    <h5 class="mbr-section-title card-title mbr-fonts-style align-center m-0 display-5">
                                        <strong>THE SUPER MARIO BROS. MOVIE<br></strong>
                                    </h5>
                                    <h6 class="mbr-role mbr-fonts-style align-center mb-3 display-4"><strong>In Cinemas
                                            7th April&nbsp;</strong></h6>
                                    ...
                                    <div class="social-row display-7">
                                        <div class="soc-item">
                                             <script>
                                                function openVideo3() {
                                                    var videoContainer = document.getElementById("video-container");
                                                    videoContainer.innerHTML = '<iframe width="560" height="1080" src="https://www.youtube.com/embed/TnGl01FkMMo" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>';
                                                }
                                            </script>
                                            <a href="#vid">
                                            <span onclick="openVideo3()"
                                                class=" mbr-iconfont mobi-mbri-play mobi-mbri"></span>
                                            </a>
                                        </div>
                                        <div class="soc-item">
                        ...
                        <div class="embla__slide slider-image item" style="margin-left: 0rem; margin-right: 0rem;">
                            <div class="card-wrap">
                                <div class="item-wrapper position-relative">
                                    <div class="image-wrap">
                                        <img src="assets/images/ed001717-74ca-44f2-a062-839e21f6373f-450x600.jpg"
                                            alt="Johnwick" data-slide-to="4" data-bs-slide-to="4">
                                    </div>
                                </div>
                                <div class="content-wrap">
                                    <h5 class="mbr-section-title card-title mbr-fonts-style align-center m-0 display-5">
                                    ...
                                    <div class="social-row display-7">
                                        <div class="soc-item">
                                             <script>
                                                function openVideo4() {
                                                    var videoContainer = document.getElementById("video-container");
                                                    videoContainer.innerHTML = '<iframe width="560" height="1080" src="https://www.youtube.com/embed/qEVUtrk8_B4" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>';
                                                }
                                            </script>
                                            <a href="#vid">
                                            <span onclick="openVideo4()"
                                                class=" mbr-iconfont mobi-mbri-play mobi-mbri"></span>
                                            </a>
                                        </div>
                                        <div class="soc-item">
                        ...
                        <div class="embla__slide slider-image item" style="margin-left: 0rem; margin-right: 0rem;">
                            <div class="card-wrap">
                                <div class="item-wrapper position-relative">
                                    <div class="image-wrap">
                                        <img src="assets/images/b0246e07-9c7e-4d27-9864-a40022953217-450x600.jpg"
                                            alt="Johnwick" data-slide-to="5" data-bs-slide-to="5">
                                    </div>
                                </div>
                                <div class="content-wrap">
                                    <h5 class="mbr-section-title card-title mbr-fonts-style align-center m-0 display-5">
                                        <strong>GAADI : CHILDREN OF THE SUN</strong>
                                    </h5>
                                    <h6 class="mbr-role mbr-fonts-style align-center mb-3 display-4"><strong>In Cinemas
                                            24th March&nbsp;</strong></h6>
                                    ...
                                    <div class="social-row display-7">
                                        <div class="soc-item">
                                             <script>
                                                function openVideo5() {
                                                    var videoContainer = document.getElementById("video-container");
                                                    videoContainer.innerHTML = '<iframe width="560" height="1080" src="https://www.youtube.com/embed/XoCG9FaqvLk" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>';
                                                }
                                            </script>
                                            <a href="#vid">
                                            <span onclick="openVideo5()"
                                                class=" mbr-iconfont mobi-mbri-play mobi-mbri"></span>
                                            </a>
                                        </div>
                                        <div class="soc-item">
                        ...
                        <div class="embla__slide slider-image item" style="margin-left: 0rem; margin-right: 0rem;">
                            <div class="card-wrap">
                                <div class="item-wrapper position-relative">
                                    <div class="image-wrap">
                                        <img src="assets/images/69e397a4-484f-48e3-b3e2-7d88eb2bbf23-450x600.jpg"
                                            alt="Johnwick" data-slide-to="6" data-bs-slide-to="6">
                                    </div>
                                </div>
                                <div class="content-wrap">
                                    <h5 class="mbr-section-title card-title mbr-fonts-style align-center m-0 display-5">
                                        <strong>RAANGI </strong><br><strong>(TAMIL)</strong>
                                    </h5>
                                    <h6 class="mbr-role mbr-fonts-style align-center mb-3 display-4"><strong>In Cinemas
                                            30th December&nbsp;</strong></h6>
                                    ...
                                    <div class="social-row display-7">
                                        <div class="soc-item">
                                             <script>
                                                function openVideo6() {
                                                    var videoContainer = document.getElementById("video-container");
                                                    videoContainer.innerHTML = '<iframe width="560" height="1080" src="https://www.youtube.com/embed/fgXHthHVj-A" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>';
                                                }
                                            </script>
                                            <a href="#vid">
                                            <span onclick="openVideo6()"
                                                class=" mbr-iconfont mobi-mbri-play mobi-mbri"></span>
                                            </a>
                                        </div>
                                        <div class="soc-item">
                        ...
                        <div class="embla__slide slider-image item" style="margin-left: 0rem; margin-right: 0rem;">
                            <div class="card-wrap">
                                <div class="item-wrapper position-relative">
                                    <div class="image-wrap">
                                        <img src="assets/images/3fc0f04d-f2d1-4581-9759-79160f2b4db0-450x600.jpg"
                                            alt="Johnwick" data-slide-to="7" data-bs-slide-to="7">
                                    </div>
                                </div>
                                <div class="content-wrap">
                                    <h5 class="mbr-section-title card-title mbr-fonts-style align-center m-0 display-5">
                                    ...
                                    <div class="social-row display-7">
                                        <div class="soc-item">
                                             <script>
                                                function openVideo7() {
                                                    var videoContainer = document.getElementById("video-container");
                                                    videoContainer.innerHTML = '<iframe width="560" height="1080" src="https://www.youtube.com/embed/W8Sqk1GcqxY" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>';
                                                }
                                            </script>
                                            <a href="#vid">
                                            <span onclick="openVideo7()"
                                                class=" mbr-iconfont mobi-mbri-play mobi-mbri"></span>
                                            </a>
                                        </div>
                                        <div class="soc-item">
                        ...
                        <div class="embla__slide slider-image item" style="margin-left: 0rem; margin-right: 0rem;">
                            <div class="card-wrap">
                                <div class="item-wrapper position-relative">
                                    <div class="image-wrap">
                                        <img src="assets/images/1589b87e-697f-4193-bcbc-ac9d70faf783-450x600.jpg"
                                            alt="Johnwick" data-slide-to="8" data-bs-slide-to="8">
                                    </div>
                                </div>
                                <div class="content-wrap">
                                    <h5 class="mbr-section-title card-title mbr-fonts-style align-center m-0 display-5">
                                        <strong>KNOCK AT THE</strong><br><strong> CABIN</strong>
                                    </h5>
                                    <h6 class="mbr-role mbr-fonts-style align-center mb-3 display-4"><strong>In Cinemas
                                            3rd February&nbsp;</strong></h6>
                                    ...
                                    <div class="social-row display-7">
                                        <div class="soc-item">
                                             <script>
                                                function openVideo8() {
                                                    var videoContainer = document.getElementById("video-container");
                                                    videoContainer.innerHTML = '<iframe width="560" height="1080" src="https://www.youtube.com/embed/0wiBHEACNHs" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>';
                                                }
                                            </script>
                                            <a href="#vid">
                                            <span onclick="openVideo8()"
                                                class=" mbr-iconfont mobi-mbri-play mobi-mbri"></span>
                                            </a>
                                        </div>
                                        <div class="soc-item">
    ...
    <section data-bs-version="5.1" class="header1 cid-l1ENjxaqp8" id="design-block-l1ENjxaqp8">
   


        <div class="divider-top divider-triangles"></div>
        <div class="divider-bottom"></div>
    </section>

    <section data-bs-version="5.1" class="header3 cid-ulGHYMjlEP mbr-fullscreen" id="design-block-ulGHYMjlEP">
        ...
        <div class="container">
            <div class="media-container-row">
                <div class="mbr-figure" style="width: 105%;">
                    <img src="assets/images/mbr-1192x1192.png" alt="">
                </div>

                <div class="media-content">
                    <h1 class="mbr-section-title mbr-white pb-3 mbr-fonts-style display-1">GET OUR MOBILE APP RIGHT NOW!
                    </h1>

                    <div class="mbr-section-text mbr-white pb-3 ">
                        <p class="mbr-text mbr-fonts-style display-5">Get ready to revolutionize the way you book your
                            tickets and stay updated! Our new app, Storytime! .</p>
                    </div>
                    <div>
                        <a href="notfound.php" class="appstore android-btn"><img
                                src="assets/images/pngwing.com-9-400x400.png" alt=""></a><a>
                        </a><a href="notfound.php" class="appstore ios-btn"><img
                                src="assets/images/pngwing.com-11-400x138.png" alt=""></a>
                    </div>
                </div>
            </div>
        </div>
        <div class="mbr-arrow hidden-sm-down" aria-hidden="true">
            <a href="#up">
                <i class="mbr-iconfont mobi-mbri-arrow-up mobi-mbri" media-simple="true"></i>
            </a>
        </div>
    </section>

    <section data-bs-version="5.1" class="cid-RoFGlPNaCW" id="design-block-RoFGlPNaCW">
    ...
    <section data-bs-version="5.1" class="footer3 cid-truEnFkGRK" once="footers" id="footer3-18">
            ...
            <div class="media-container-row align-center mbr-white">
                <div class="row row-links">
                    <ul class="foot-menu">
                        ...
                        <li class="foot-menu-item mbr-fonts-style display-7">
                            <a class="text-white text-primary" href="aboutus.php" target="_blank">About us</a>
                        </li>
                        <li class="foot-menu-item mbr-fonts-style display-7"><a href="contatus.php"
                                class="text-white text-primary">Contact us</a></li>
                        <li class="foot-menu-item mbr-fonts-style display-7"><a href="locations.php"
                                class="text-white text-primary">Locations</a></li>
                    </ul>
                </div>
                ...
                <div class="row row-copirayt">
                    <p class="mbr-text mb-0 mbr-fonts-style mbr-white align-center display-7">
                        © Copyright 2023 Storytime. All Rights Reserved.
                    </p>
                </div>
            </div>
        </div>
    ...
    <section data-bs-version="5.1" class="_customHTML cid-JkGWHLfTE4" id="design-block-JkGWHLfTE4">
    ...
    <section data-bs-version="5.1" class="mbr-section cid-wPjPCUWfMp" id="design-block-wPjPCUWfMp">
