...
<head>
  ...
  <link rel="shortcut icon" href="assets/images/840fd541-310f-44dd-ac01-5d4bf86db538-1-450x600.jpg" type="image/x-icon">
  <meta name="description" content="Avatar2">


  <title>STORYTIME | BOOKING : AVATAR</title>
  ...
  <link rel="preload"
    href="https://fonts.googleapis.com/css?family=M+PLUS+Rounded+1c:100,300,400,500,700,800,900&display=swap" as="style"
...
<body>
  ...
  <section data-bs-version="5.1" class="header2 cid-tvfs2HayZn mbr-parallax-background" id="header2-2c">
    ...
    <div class="container">
      <div class="row">
        <div class="col-12 col-lg-7">
          <h1 class="mbr-section-title mbr-fonts-style mb-3 display-1"><strong>Avatar 2</strong></h1>

          <p class="mbr-text mbr-fonts-style display-7">Jake Sully and Ney'tiri have formed a family and are doing
            everything to stay together. However, they must leave their home and explore the regions of Pandora. When an
            ancient threat resurfaces, Jake must fight a difficult war against the humans.</p>
          <div class="mbr-section-btn mt-3"><a class="btn btn-secondary display-4" href="">Book Now</a>
            <a class="btn btn-primary-outline display-4" href="https://www.youtube.com/watch?v=a8Gx8wiNbs8">Trailer
              &gt;</a>
          </div>
        </div>
      </div>
  ...
  <section data-bs-version="5.1" class="_customHTML cid-tvfmerVZeY" id="design-block-2b">
    ...
    <div style="padding:1rem; background-color:#c1c1c1;" class="hidden">
      <div class="align-center">
        <h10> <br><br><br><br><br><br>Scroll Indicator - Progress bar<br>
          ...
          preview/publish.<br><br><svg id="svg" version="1.1" xmlns="http://www.w3.org/2000/svg"
  ...
  <body">
      ...
      <div class="w3ls-reg">
        ...
        <div class="displayerBoxes txt-center" style="overflow-x:auto;">
          ...
          <div class="txt-center" style="margin-top: 10px;">
            <button onclick="processBooking()" class="btn btn-primary" style="margin-left: 1cm;">Confirm Booking</button>
          </div>
          <script>
            function processBooking() {
              const numberOfSeats = parseInt(document.getElementById('NumberDisplay').value);

              if (numberOfSeats === 1) {
                // Redirect when number of seats is 1
                window.location.href = 'https://book.stripe.com/test_eVa9BHgG2dl699u002';
              } else if (numberOfSeats === 2) {
                // Redirect when number of seats is 2
                window.location.href = 'https://book.stripe.com/test_fZe4hn75s94Q85qdQT';
              } else if (numberOfSeats === 3) {
                // Redirect when number of seats is 3
                window.location.href = 'https://book.stripe.com/test_cN24hn75s3KwclG9AE';
              } else if (numberOfSeats === 4) {
                // Redirect when number of seats is 4
                window.location.href = 'https://book.stripe.com/test_7sI15bcpM4OAady9AF';
              } else if (numberOfSeats === 5) {
                // Redirect when number of seats is 5
                window.location.href = 'https://book.stripe.com/test_dR6dRX0H4a8Uady7sy';
              } else if (numberOfSeats === 6) {
                // Redirect when number of seats is 6
                window.location.href = 'https://book.stripe.com/test_eVa9BH4Xkdl63PadQX';
              } else if (numberOfSeats === 7) {
                // Redirect when number of seats is 7
                window.location.href = 'https://book.stripe.com/test_bIY5lrahEgxi4Te8wE';
              } else if (numberOfSeats === 8) {
                // Redirect when number of seats is 8
                window.location.href = 'https://book.stripe.com/test_bIY15b3Tg1Co99u6ox';
              } else if (numberOfSeats === 9) {
                // Redirect when number of seats is 9
                window.location.href = 'https://book.stripe.com/test_28o4hn3Tggxi85q5ku';
              } else if (numberOfSeats === 10) {
                // Redirect when number of seats is 10
                window.location.href = 'https://book.stripe.com/test_eVabJPdtQbcY3PacMX';
              }else {
                // Handle other cases or provide an error message
                alert('Press Confirm Booking');
              }
            }
          </script>
    ...
    <section data-bs-version="5.1" class="footer3 cid-tvxHyrIXTB" once="footers" id="footer3-2s">
