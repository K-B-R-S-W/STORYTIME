...
<head>
    ...
    <link rel="shortcut icon" href="assets/images/hitmans-wife-social.jpg" type="image/x-icon">
    <meta name="description" content="John Wick">


    <title>STORYTIME | BOOKING : John Wick: Chapter 4</title>
...
<body>
    ...
    <section data-bs-version="5.1" class="menu cid-tvxGDsMvE3" once="menu" id="menu1-2m">
    ...
    <section data-bs-version="5.1" class="header2 cid-tvxGDtet9 mbr-parallax-background" id="header2-2n">
        ...
        <div class="container">
            <div class="row">
                <div class="col-12 col-lg-7">
                    <h1 class="mbr-section-title mbr-fonts-style mb-3 display-1"><strong>John Wick Chapter 4</strong></h1>

                    <p class="mbr-text mbr-fonts-style display-7">With the price on his head ever increasing, legendary hit man John Wick takes his fight against the High Table global as he seeks out the most powerful players in the underworld, from New York to Paris to Japan to Berlin.</p>
                    <div class="mbr-section-btn mt-3"><a class="btn btn-secondary display-4"
                            href="">Book Now</a>
                        <a class="btn btn-primary-outline display-4"
                            href="https://www.youtube.com/watch?v=qEVUtrk8_B4">Trailer &gt;</a>
                    </div>
                </div>
            </div>
        </div>
    ...
    <section data-bs-version="5.1" class="footer3 cid-tvxI9daTxK" once="footers" id="footer3-2u">
    ...
    <section data-bs-version="5.1" class="_customHTML cid-tvxGDtJU4Q" id="design-block-2o">
