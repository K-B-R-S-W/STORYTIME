...
<head>
    ...
    <link rel="shortcut icon" href="assets/img/8Gxv8gSFCU0XGDykEGv7zR1n2ua.jpg" type="image/x-icon">
    <meta name="description" content="Oppenheimer">


    <title>STORYTIME | BOOKING : Oppenheimer</title>
...
<body>
    ...
    <section data-bs-version="5.1" class="header2 cid-tvxt9 mbr-parallax-background" id="header2-2n">
