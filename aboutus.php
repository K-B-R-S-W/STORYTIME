...
<head>
    ...
    <title>STORYTIME | ABOUT US</title>
    <link rel="stylesheet" href="assets/web/assets/icons2/new.css">
    <link rel="stylesheet" href="assets/web/assets/icons/iconss.css">
...
<body>
    ...
    <section data-bs-version="5.1" class="header6 cid-trwrLaEjhn"
        data-bg-video="https://player.vimeo.com/video/867467436" id="header6-1v">
        ...
        <div class="align-center container-fluid">
            <div class="row justify-content-center">
                <div class="col-12 col-lg-10">
                    <h1 class="mbr-section-title mbr-fonts-style mbr-white mb-3 display-1"><strong>Our Campus</strong>
                    </h1>

                    <p class="mbr-text mbr-white mbr-fonts-style display-7">
                        Sir Lanka Technological Campus is the first of its kind in South Asia. We offer undergraduate and
                        postgraduate programmes in the fields of Business, Computing, Engineering, Design and Science in
                        an alternative and innovative approach to higher education.
                    </p>
                    <div class="mbr-section-btn mt-3"><a class="btn btn-secondary display-4"
                            href="https://sltc.ac.lk/" target="_blank">Visit Now!</a></div>
                </div>
            </div>
        </div>
    </section>

    <section data-bs-version="5.1" class="people5 mbr-embla cid-trwuGdVSbj" id="people5-1w">
        ...
        <div class="position-relative text-center">
            ...
            <div class="embla" data-skip-snaps="true" data-align="center" data-auto-play="true"
                            ...
                            <div class="user">
                                <div class="user_image">
                                    <div class="item-wrapper position-relative">
                                        <img src="assets/images/309382299-1441715136322774-8553515753243638491-n-600x600.jpg"
                                            alt="  " data-slide-to="0" data-bs-slide-to="0">
                                    </div>
                                </div>
                                <div class="user_text mb-4">
                                    <p class="mbr-fonts-style display-7">I'm K.B.R.S.Wijerathna, an undergraduate student
                                        studying in SLTC Research University pursuing the BSC in Data Science degree program</p>
                                </div>
                                <div class="user_name mbr-fonts-style mb-2 display-7">
                                    <strong>K.B.R.S.WIJERATNA</strong>
                                </div>
                                <div class="user_desk mbr-fonts-style display-7"> DEVELOPER - 21UG1143
                                </div>
                            </div>
                        </div>
                        <div class="embla__slide slider-image item active"
                            ...
                            <div class="user">
                                <div class="user_image">
                                    <div class="item-wrapper position-relative">
                                        <img src="assets/images/whatsapp-image-2022-12-31-at-01.49.49-400x533.jpeg"
                                            alt="  " data-slide-to="1" data-bs-slide-to="1">
                                    </div>
                                </div>
                                <div class="user_text mb-4">
                                    <p class="mbr-fonts-style display-7"> I'm M.H.Jayasuriya, an undergraduate student
                                        studying in SLTC Research University pursuing the BSC in Data Science degree program
                                        </p>
                                </div>
                                <div class="user_name mbr-fonts-style mb-2 display-7">
                                    <strong>M.H.JAYASURIYA</strong>
                                </div>
                                <div class="user_desk mbr-fonts-style display-7">DEVELOPER - 21UG1165
                                </div>
                            </div>
                        </div>
                        <div class="embla__slide slider-image item active"
                            ...
                            <div class="user">
                                <div class="user_image">
                                    <div class="item-wrapper position-relative">
                                        <img src="assets/img/chanuk.jpg"
                                            alt="  " data-slide-to="2" data-bs-slide-to="2">
                                    </div>
                                </div>
                                <div class="user_text mb-4">
                                    <p class="mbr-fonts-style display-7"> I'm K.L.C.K. Liyanage, an undergraduate student
                                        studying in SLTC Research University pursuing the BSC in Data Science degree program</p>
                                </div>
                                <div class="user_name mbr-fonts-style mb-2 display-7"><strong>K.L.C.K. LIYANAGE</strong>
                                </div>
                                <div class="user_desk mbr-fonts-style display-7">DEVELOPER - 21UG1054
                                </div>
                            </div>
                        </div>
                        <div class="embla__slide slider-image item active"
                            ...
                            <div class="user">
                                <div class="user_image">
                                    <div class="item-wrapper position-relative">
                                        <img src="assets/images/tharindu.jpg" alt="  "
                                            data-slide-to="3" data-bs-slide-to="3">
                                    </div>
                                </div>
                                <div class="user_text mb-4">
                                    <p class="mbr-fonts-style display-7">I’m Tharindu Mihiran, an undergraduate student
                                        studying in SLTC Research University pursuing the BSC in Cyber security degree program
                                        </p>
                                </div>
                                <div class="user_name mbr-fonts-style mb-2 display-7"><strong>THARINDU MIHIRAN</strong>
                                </div>
                                <div class="user_desk mbr-fonts-style display-7">DEVELOPER - 21UG1267
                                </div>
                            </div>
                        </div>
                        <div class="embla__slide slider-image item active"
                            ...
                            <div class="user">
                                ...
                                <div class="user_text mb-4">
                                    <p class="mbr-fonts-style display-7">I'm K.D. De Silva Samarasinghe, an undergraduate student
                                        studying in SLTC Research University pursuing the BSC in Data Science degree program
                                        </p>
                                </div>
                                <div class="user_name mbr-fonts-style mb-2 display-7"><strong>K.D. DE SILVA SAMARASINGHE</strong></div>
                                <div class="user_desk mbr-fonts-style display-7">DEVELOPER - 21UG1128
                                </div>
                            </div>
                        </div>  
                    </div>
    ...
    <section data-bs-version="5.1" class="content17 cid-trwZ8f8YBO" id="content17-24">
                ...
                <div class="col-12 col-md-10">
                    ...
                    <div id="bootstrap-toggle" class="toggle-panel accordionStyles tab-content">
                        <div class="card mb-3">
                            <div class="card-header" role="tab" id="headingOne">
                                <a role="button" class="collapsed panel-title text-black" data-toggle="collapse"
                                    data-bs-toggle="collapse" data-core="" href="#collapse1_36" aria-expanded="false"
                                    aria-controls="collapse1">
                                    <h6 class="panel-title-edit mbr-fonts-style mb-0 display-7"><strong>Is tickets
                                            refundable?</strong>
                                    </h6>
                            ...
                            <div id="collapse1_36" class="panel-collapse noScroll collapse" role="tabpanel"
                                ...
                                <div class="panel-body">
                                    <p class="mbr-fonts-style panel-text display-7">No , Unfortunately tickets cannot be
                                        refunded Due to T&amp;C of cinemas</p>
                                </div>
                            </div>
                        </div>
                        <div class="card mb-3">
                            <div class="card-header" role="tab" id="headingTwo">
                                <a role="button" class="collapsed panel-title text-black" data-toggle="collapse"
                                    data-bs-toggle="collapse" data-core="" href="#collapse2_36" aria-expanded="false"
                                    aria-controls="collapse2">
                                    <h6 class="panel-title-edit mbr-fonts-style mb-0 display-7"><strong>Does my payment
                                            secure?</strong>
                                    </h6>
                                    <span class="sign mbr-iconfont mbri-arrow-down"></span>
                                </a>
                            ...
                            <div id="collapse2_36" class="panel-collapse noScroll collapse" role="tabpanel"
                                ...
                                <div class="panel-body">
                                    <p class="mbr-fonts-style panel-text display-7">Yes! An TLS/SSL certificate protects
                                        your payment process.</p>
                                </div>
                            </div>
                        </div>
                        <div class="card mb-3">
                            <div class="card-header" role="tab" id="headingThree">
                                <a role="button" class="collapsed panel-title text-black" data-toggle="collapse"
                                    data-bs-toggle="collapse" data-core="" href="#collapse3_36" aria-expanded="false"
                                    aria-controls="collapse3">
                                    <h6 class="panel-title-edit mbr-fonts-style mb-0 display-7"><strong>Do you keep your
                                            confidential&nbsp; data?</strong>
                                    </h6>
                                    <span class="sign mbr-iconfont mbri-arrow-down"></span>
                                </a>
                            </div>
                            <div id="collapse3_36" class="panel-collapse noScroll collapse" role="tabpanel"
                                ...
                                <div class="panel-body">
                                    <p class="mbr-fonts-style panel-text display-7">No, we do not keep our customers'
                        ...
                        <div class="card mb-3">
                            <div class="card-header" role="tab" id="headingThree">
                                <a role="button" class="collapsed panel-title text-black" data-toggle="collapse"
                                    data-bs-toggle="collapse" data-core="" href="#collapse4_36" aria-expanded="false"
                                    aria-controls="collapse4">
                                    <h6 class="panel-title-edit mbr-fonts-style mb-0 display-7"><strong>Can I
                                            re-schedule my booking?</strong>
                                    </h6>
                                    <span class="sign mbr-iconfont mbri-arrow-down"></span>
                                </a>
                            </div>
                            <div id="collapse4_36" class="panel-collapse noScroll collapse" role="tabpanel"
                                ...
                                <div class="panel-body">
                                    <p class="mbr-fonts-style panel-text display-7">
                                        No, you are unable to reschedule. As stated in our terms and conditions, this is
    ...
    <section data-bs-version="5.1" class="cid-2OSjqlF5HD" id="design-block-2OSjqlF5HD">
        ...
        <svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
            ...
            <path class="wave1"
                d="M1538.6,349.9c-8.5-5.8-17-11.5-25.4-17.2c-201.1-134-443.1-203.1-683.1-195.3c-227.5,7.5-446.5,85.8-635.3,212.4H1538.6z">
            </path>
            <path class="wave2"
                d="M3510.8,204.2c-20.4-11.2-41.6-21.2-62.2-29.5c-82.7-33.3-189.3-48.1-283.7-29.4c-145.5,29-226.9,126.3-365.6,165.7c-122,34.6-266.8,18.4-392.2-11.3c-243.9-57.8-476.4-125.1-746.4-111c-148,7.7-291,38.8-421.4,82c-134.5,44.6-293.8,106.7-448.7,58.3c-131.8-41.3-200.4-132.1-322.4-182c-91.2-37.3-207.8-50.7-315.1-36.3C98,118.1,45.7,132.9,0,153.3v197.2h3510.8V204.2z">
            </path>
            <path class="wave1"
                d="M3510.8,282.8c-117.5-97.4-255.6-201.2-413.4-176.4c-111.4,17.5-184.7,114-282.7,161c-127.3,61-227.1-16.9-341-69.3c-153.7-70.6-343.6-51.4-480.7,48.6c-42.4,31-83,70-125.2,103.2h1643V282.8z">
            </path>
            <path class="wave1"
                d="M3510.8,161.9c-21.6-2.7-43-3.1-62.3-1.6c-73,5.5-142.2,33.4-209.5,62.3c-67.3,28.9-134.9,59.4-207.2,70.9c-241.2,38.3-440.7-133.6-663.5-189c-201.9-50.2-415.8-6.8-611.8,62.6c-199.5,70.6-405.5,169.7-612.9,127.5c-146-29.7-268.2-125.9-403.1-189.1C501.4-6.7,247.5-4.2,0,50.1v299.8h3510.8V161.9z">
            </path>
        </svg>

    </section>

    <section data-bs-version="5.1" class="footer3 cid-truEnFkGRK" once="footers" id="footer3-1t">
    ...
    <section data-bs-version="5.1" class="mbr-section cid-trwI8NouTy" id="design-block-1z">
    ...
    <section data-bs-version="5.1" class="_customHTML cid-trwI8o58E2" id="design-block-1y">
