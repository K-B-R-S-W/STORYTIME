...
<head>
  ...
  <link rel="shortcut icon" href="assets/images/2b54ba89-e867-45dd-97df-8a342462971d-1-450x600.jpg" type="image/x-icon">
  <meta name="description" content="blackadam">
  
  
  <title>STORYTIME | BOOKING : BLACKADAM</title>
...
<body>
  ...
  <section data-bs-version="5.1" class="menu cid-tvxGsLLlI8" once="menu" id="menu1-2j">
    ...
    <nav class="navbar navbar-dropdown navbar-fixed-top navbar-expand-lg">
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav nav-dropdown" data-app-modern-menu="true"><li class="nav-item"><a class="nav-link link text-white text-primary display-4" href="Movies.php">Movies</a></li><li class="nav-item"><a class="nav-link link text-white text-primary display-4" href="locations.php">Locations</a></li><li class="nav-item"><a class="nav-link link text-white text-primary display-4" href="contatus.php">Contact Us</a></li>
                    <li class="nav-item"><a class="nav-link link text-white text-primary display-4" href="aboutus.php">About Us</a></li></ul>
...
<section data-bs-version="5.1" class="header2 cid-tvxGsMaPW9 mbr-parallax-background" id="header2-2k">
    ...
    <div class="container">
        <div class="row">
            <div class="col-12 col-lg-7">
                <h1 class="mbr-section-title mbr-fonts-style mb-3 display-1"><strong>Black Adam&nbsp;</strong></h1>
                
                <p class="mbr-text mbr-fonts-style display-7">After being bestowed with godly powers and imprisoned for it, Black Adam is liberated from his earthly binds to unleash his fury on the modern world.</p>
                <div class="mbr-section-btn mt-3"><a class="btn btn-secondary display-4" href="">Book Now</a>
                    <a class="btn btn-primary-outline display-4" href="https://www.youtube.com/watch?v=mkomfZHG5q4">Trailer &gt;</a></div>
            </div>
        </div>
    </div>
</section>

<section data-bs-version="5.1" class="_customHTML cid-tvxGsMC7Pl" id="design-block-2l">
...
<section data-bs-version="5.1" class="footer3 cid-tvxHHqI34m" once="footers" id="footer3-2t">
        ...
        <div class="media-container-row align-center mbr-white">
            <div class="row row-links">
                ...
                <li class="foot-menu-item mbr-fonts-style display-7">
                    ...
                    </li><li class="foot-menu-item mbr-fonts-style display-7"><a href="contatus.php" class="text-white text-primary">Contact us</a></li><li class="foot-menu-item mbr-fonts-style display-7"><a href="locations.php" class="text-white text-primary">Locations</a></li></ul>
            </div>
