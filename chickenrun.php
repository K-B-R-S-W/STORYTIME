...
<head>
    ...
    <link rel="shortcut icon" href="assets/img/maxresdefault.jpg" type="image/x-icon">
    <meta name="description" content="Chicken Run">


    <title>STORYTIME | BOOKING : Chicken Run: Dawn of the Nugget</title>
...
<body>
    ...
    <section data-bs-version="5.1" class="header2 cid-tvxGDtt9 mbr-parallax-background" id="header2-2n">
        ...
        <div class="container">
            <div class="row">
                <div class="col-12 col-lg-7">
                    <h1 class="mbr-section-title mbr-fonts-style mb-3 display-1"><strong>Chicken Run Dawn of the Nugget</strong></h1>

                    <p class="mbr-text mbr-fonts-style display-7">A band of fearless chickens flock together to save poultry-kind from an unsettling new threat: a nearby farm that's cooking up something suspicious.</p>
                    <div class="mbr-section-btn mt-3"><a class="btn btn-secondary display-4"
                            href="">Book Now</a>
                        <a class="btn btn-primary-outline display-4"
                            href="https://www.youtube.com/watch?v=_-Kz67kea8Q&t=1s">Trailer &gt;</a>
                    </div>
                </div>
            </div>
        </div>
