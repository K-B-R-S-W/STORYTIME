...
<head>
  ...
  <noscript>
    <link rel="stylesheet" href="https://fonts.googleapis.com/css?family=M+PLUS+Rounded+1c:100,300,400,500,700,800,900&display=swap">
  </noscript>
...
<body>
    ...
    <nav class="navbar navbar-dropdown navbar-fixed-top navbar-expand-lg">
      <div class="container-fluid">
        <div class="navbar-brand">
          ...
          <span class="navbar-caption-wrap"><a class="navbar-caption text-white display-5" href="index.php">STORYTIME</a></span>
        </div>
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
          <ul class="navbar-nav nav-dropdown" data-app-modern-menu="true">
            <li class="nav-item"><a class="nav-link link text-white text-primary display-4" href="Movies.php">Movies</a></li>
            <li class="nav-item"><a class="nav-link link text-white text-primary display-4" href="locations.php">Locations</a></li>
            <li class="nav-item"><a class="nav-link link text-white text-primary display-4" href="contatus.php">Contact
                Us</a></li>
            <li class="nav-item"><a class="nav-link link text-white text-primary display-4" href="aboutus.php">About
                Us</a></li>
          </ul>

          <div class="navbar-buttons mbr-section-btn"><a class="btn btn-primary display-4" href="Movies.php">BUY NOW</a></div>
        </div>
      </div>
    </nav>
  ...
  <section data-bs-version="5.1" class="slider1 cid-tvxsWYcrwd" id="slider1-2i">

    <div class="carousel slide carousel-fade" id="tvxJMODRTk" data-ride="carousel" data-bs-ride="carousel" data-interval="3000" data-bs-interval="3000">
      <ol class="carousel-indicators">
        <li data-slide-to="0" data-bs-slide-to="0" class="active" data-target="#tvxJMODRTk" data-bs-target="#tvxJMODRTk"></li>
        <li data-slide-to="1" data-bs-slide-to="1" class="" data-target="#tvxJMODRTk" data-bs-target="#tvxJMODRTk"></li>
        <li data-slide-to="2" data-bs-slide-to="2" class="" data-target="#tvxJMODRTk" data-bs-target="#tvxJMODRTk"></li>
        <li data-slide-to="3" data-bs-slide-to="3" class="" data-target="#tvxJMODRTk" data-bs-target="#tvxJMODRTk"></li>
        <li data-slide-to="4" data-bs-slide-to="4" class="" data-target="#tvxJMODRTk" data-bs-target="#tvxJMODRTk"></li>
        <li data-slide-to="5" data-bs-slide-to="5" class="" data-target="#tvxJMODRTk" data-bs-target="#tvxJMODRTk"></li>
        <li data-slide-to="6" data-bs-slide-to="6" class="" data-target="#tvxJMODRTk" data-bs-target="#tvxJMODRTk"></li>
        <li data-slide-to="7" data-bs-slide-to="7" class="" data-target="#tvxJMODRTk" data-bs-target="#tvxJMODRTk"></li>
      ...
      <div class="carousel-inner">
        <div class="carousel-item slider-image item active">
          <div class="item-wrapper">
            <img class="d-block w-100" src="assets/images/cZ_fNwqY9JG0.jpg" alt="Mobirise Website Builder" data-slide-to="0" data-bs-slide-to="0">

            <div class="carousel-caption">
              <h5 class="mbr-section-subtitle mbr-fonts-style display-5"><strong>Chicken Run: Dawn of the Nugget</strong>
              </h5>
              <p class="mbr-section-text mbr-fonts-style display-7">NOW SHOWING</p>
            </div>
          </div>
        </div>
        ...
        <div class="carousel-item slider-image item">
          <div class="item-wrapper">
            <img class="d-block w-100" src="assets/img/maxresdefault (1).jpg" alt="Mobirise Website Builder" data-slide-to="1" data-bs-slide-to="1">

            <div class="carousel-caption">
              <h5 class="mbr-section-subtitle mbr-fonts-style display-5"><strong>The Family Plan</strong>
              </h5>
              <p class="mbr-section-text mbr-fonts-style display-7">NOW SHOWING</p>
            </div>
          </div>
        ...
        <div class="carousel-item slider-image item">
          <div class="item-wrapper">
            <img class="d-block w-100" src="assets/img/share.jpg" alt="Mobirise Website Builder" data-slide-to="2" data-bs-slide-to="2">

            <div class="carousel-caption">
              <h5 class="mbr-section-subtitle mbr-fonts-style display-5"><strong>Barbie</strong>
              </h5>
              <p class="mbr-section-text mbr-fonts-style display-7">NOW SHOWING</p>
            </div>
          </div>
        ...
        <div class="carousel-item slider-image item">
          <div class="item-wrapper">
            <img class="d-block w-100" src="assets/img/maxresde.jpg" alt="Mobirise Website Builder" data-slide-to="3" data-bs-slide-to="3">

            <div class="carousel-caption">
              <h5 class="mbr-section-subtitle mbr-fonts-style display-5"><strong>Oppenheimer</strong>
              </h5>
              <p class="mbr-section-text mbr-fonts-style display-7">NOW SHOWING</p>
            </div>
          </div>
        ...
        <div class="carousel-item slider-image item">
          <div class="item-wrapper">
            <img class="d-block w-100" src="assets/images/download-1-1900x1069.jpg" alt="Mobirise Website Builder" data-slide-to="4" data-bs-slide-to="4">

            <div class="carousel-caption">
              <h5 class="mbr-section-subtitle mbr-fonts-style display-5"><strong>Avatar 2 : The Way of Water</strong>
              </h5>
              <p class="mbr-section-text mbr-fonts-style display-7">NOW SHOWING</p>
            </div>
          </div>
        ...
        <div class="carousel-item slider-image item">
          <div class="item-wrapper">
            <img class="d-block w-100" src="assets/images/uwp819718-1900x1069.jpg" alt="Mobirise Website Builder" data-slide-to="5" data-bs-slide-to="5">

            <div class="carousel-caption">
              <h5 class="mbr-section-subtitle mbr-fonts-style display-5"><strong>Black Panther: Wakanda Forever</strong>
              </h5>
              <p class="mbr-section-text mbr-fonts-style display-7">NOW SHOWING</p>
            </div>
          </div>
        ...
        <div class="carousel-item slider-image item">
          <div class="item-wrapper">
            <img class="d-block w-100" src="assets/images/download-2-1900x1069.jpg" alt="Mobirise Website Builder" data-slide-to="6" data-bs-slide-to="6">
        ...
        <div class="carousel-item slider-image item">
          <div class="item-wrapper">
            <img class="d-block w-100" src="assets/images/hitmans-wife-social.jpg" alt="Mobirise Website Builder" data-slide-to="7" data-bs-slide-to="7">

            <div class="carousel-caption">
              <h5 class="mbr-section-subtitle mbr-fonts-style display-5"><strong>John Wick: Chapter 4</strong></h5>
              <p class="mbr-section-text mbr-fonts-style display-7">NOW SHOWING</p>
            </div>
          </div>
        </div>
      </div>
      <a class="carousel-control-prev carousel-control" role="button" data-slide="prev" data-bs-slide="prev" href="#tvxJMODRTk">
        <span class="" aria-hidden="true"></span>
        <span class="sr-only visually-hidden">Previous</span>
      </a>
      <a class="carousel-control-next carousel-control" role="button" data-slide="next" data-bs-slide="next" href="#tvxJMODRTk">
        <span class="" aria-hidden="true"></span>
  ...
  <section data-bs-version="5.1" class="content4 cid-8JGegpxpT2 mbr-fullscreen" id="design-block-8JGegpxpT2">
    ...
    <div class="container-fluid">
      <div class="row justify-content-center">
        <div class="title col-md-12 col-lg-8">
          <h3 class="mbr-section-title mbr-fonts-style align-center mb-4 display-2"><strong>GET YOUR TICKETS
              NOW!</strong><br><strong><br></strong></h3>


          <div id="myBtnContainer">
            <button class="btn active" onclick="filterSelection('all')"> SHOW ALL</button>
            <button class="btn" onclick="filterSelection('nature')"> NOW SHOWING</button>
            <button class="btn" onclick="filterSelection('cars')"> UPCOMING</button>
            <button class="btn" onclick="filterSelection('people')"> TRENDING</button>
          </div>
          ...
          <div class="row">
            <div class="column nature">
              <div class="content">
                <img src="assets/images/Chicken_Run_Dawn_of_the_Nugget-981881616-large.jpg" alt="Mountains">

                <p><br><strong>Chicken Run: Dawn of the Nugget</strong><br></p>
                <p>NOW SHOWING</p>
                <div class="mbr-section-btn align-center"><a class="btn btn-primary display-4" href="chickenrun.php">BOOK
                    NOW</a></div>
              </div>
            </div>
            ...
            <div class="column nature">
              <div class="content">
                <img src="assets/img/family.jpg" alt="Mountains">

                <p><br><strong>The Family Plan</strong><br></p>
                <p>NOW SHOWING</p>
                <div class="mbr-section-btn align-center"><a class="btn btn-primary display-4" href="thefamilyplan.php">BOOK
                    NOW</a></div>
              </div>
            </div>
            ...
            <div class="column nature">
              <div class="content">
                <img src="assets/img/3aij5sA5AhK2flrjsfrVQs93CUx.jpg" alt="Mountains">

                <p><br><strong>Barbie</strong><br></p>
                <p>NOW SHOWING</p>
                <div class="mbr-section-btn align-center"><a class="btn btn-primary display-4" href="barbie.php">BOOK
                    NOW</a></div>
              </div>
            </div>
            ...
            <div class="column nature">
              <div class="content">
                <img src="assets/img/8Gxv8gSFCU0XGDykEGv7zR1n2ua.jpg" alt="Mountains">

                <p><br><strong>Oppenheimer</strong><br></p>
                <p>NOW SHOWING</p>
                <div class="mbr-section-btn align-center"><a class="btn btn-primary display-4" href="oppenheimer.php">BOOK
                    NOW</a></div>
              </div>
            </div>
            ...
            <div class="column nature">
              <div class="content">
                <img src="assets/images/840fd541-310f-44dd-ac01-5d4bf86db538-1-450x600.jpg" alt="Mountains">

                <p><br><strong>Avatar:&nbsp;The Way of Water</strong><br></p>
                <p>NOW SHOWING</p>
                <div class="mbr-section-btn align-center"><a class="btn btn-primary display-4" href="avatar2.php">BOOK
                    NOW</a></div>
              </div>
            </div>
            <div class="column nature">
              <div class="content">
                <img src="assets/images/1a1f71a9-00ea-40ea-9b55-2556294a84d4-1-450x600.jpg" alt="Lights">

                <p><br><strong>Black Panther: Wakanda Forever</strong></p>
                <p>NOW SHOWING</p>
                <div class="mbr-section-btn align-center"><a class="btn btn-primary display-4" href="blackpanther.php">BOOK
                    NOW</a></div>
            ...
            <div class="column nature">
              <div class="content">
                <img src="assets/images/2b54ba89-e867-45dd-97df-8a342462971d-1-450x600.jpg" alt="Nature">

                <p><br><strong>Black Adam</strong></p>
                <p>NOW SHOWING</p>
                <div class="mbr-section-btn align-center"><a class="btn btn-primary display-4" href="blackadam.php">BOOK
                    NOW</a></div>
              </div>
            </div>
            ...
            <div class="column nature">
              <div class="content">
                <img src="assets/images/ed001717-74ca-44f2-a062-839e21f6373f-1-450x600.jpg" alt="Nature">

                <p><br><strong>John Wick: Chapter 4</strong></p>
                <p>NOW SHOWING</p>
                <div class="mbr-section-btn align-center"><a class="btn btn-primary display-4" href="johnwick.php">BOOK
                    NOW</a></div>
              </div>
            </div>
                    ...
                    <tr>
                        ...
                        <?php foreach ($result as $value): ?>
                            <td>
                                <div class="column nature">
                                    <div class="content">
                                        <img src="../STORYTIME_HOME/assets/img/<?= $value['img'] ?>" alt="img">
                                        <p><br><strong><?= $value['Title'] ?></strong></p>
                                        <p><br><?= $value['Genre'] ?></p>
                                        <p>In Cinemas <?= $value['ReleaseDate'] ?>&nbsp;</p>
                                        <p>Duration <?= $value['Duration'] ?>&nbsp;</p>
                                        <div class="mbr-section-btn align-center">
                                            <a class="btn btn-primary display-4" href="contatus.php">NOTIFY</a>
                                        </div>
                                    </div>
                                </div>
                            </td>
  ...
  <section data-bs-version="5.1" class="header1 cid-tvx9Rsr8XI" id="design-block-2h">
  ...
  <section data-bs-version="5.1" class="footer3 cid-truEnFkGRK" once="footers" id="footer3-2f">
      ...
      <div class="media-container-row align-center mbr-white">
        <div class="row row-links">
          <ul class="foot-menu">
            ...
            <li class="foot-menu-item mbr-fonts-style display-7"><a href="contatus.php" class="text-white text-primary">Contact us</a></li>
            <li class="foot-menu-item mbr-fonts-style display-7"><a href="locations.php" class="text-white text-primary">Locations</a></li>
          </ul>
        </div>
  ...
  <section data-bs-version="5.1" class="_customHTML cid-tvx9QU3SBF" id="design-block-2g">
  ...
  <section><a href=""></a><a href=""></a></section>
