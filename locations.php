...
<head>
    ...
    <title>STORYTIME | LOCATIONS</title>
...
<body>
    ...
    <section data-bs-version="5.1" class="menu cid-truZ1H120O" once="menu" id="menu1-1h">
    ...
    <section data-bs-version="5.1" class="slider1 cid-trv39sm5UL" id="slider1-1q">

        <div class="carousel slide carousel-fade" id="trxa2IbloY" data-ride="carousel" data-bs-ride="carousel"
            data-interval="5000" data-bs-interval="5000">
            <ol class="carousel-indicators">
                <li data-slide-to="0" data-bs-slide-to="0" class="active" data-target="#trxa2IbloY"
                    data-bs-target="#trxa2IbloY"></li>
                <li data-slide-to="1" data-bs-slide-to="1" class="" data-target="#trxa2IbloY"
                    data-bs-target="#trxa2IbloY"></li>
                <li data-slide-to="2" data-bs-slide-to="2" class="" data-target="#trxa2IbloY"
                    data-bs-target="#trxa2IbloY"></li>
                <li data-slide-to="3" data-bs-slide-to="3" class="" data-target="#trxa2IbloY"
                    data-bs-target="#trxa2IbloY"></li>
            ...
            <div class="carousel-inner">
                ...
                <div class="carousel-item slider-image item active">
                    <div class="item-wrapper">
                        <img class="d-block w-100" src="assets/images/image-800x533.jpg" alt=" " data-slide-to="0"
                            data-bs-slide-to="0">

                        <div class="carousel-caption">
                            <h5 class="mbr-section-subtitle mbr-fonts-style display-5"><strong>MAJESTIC CITY -
                                    ULTRA&nbsp;</strong></h5>
                            <p class="mbr-section-text mbr-fonts-style display-7">Colombo</p>
                        </div>
                    </div>
                </div>
                <div class="carousel-item slider-image item">
                    <div class="item-wrapper">
                        <img class="d-block w-100" src="assets/images/7f3ad000-a850-43d8-81f6-af2520b2605a-800x448.png"
                            alt=" " data-slide-to="1" data-bs-slide-to="1">

                        <div class="carousel-caption">
                            <h5 class="mbr-section-subtitle mbr-fonts-style display-5"><strong>Liberty By Scope
                                    Cinemas</strong></h5>
                            <p class="mbr-section-text mbr-fonts-style display-7">Kiribathgoda</p>
                        </div>
                    </div>
                </div>
                <div class="carousel-item slider-image item">
                    <div class="item-wrapper">
                        <img class="d-block w-100" src="assets/images/85472c6c-33ba-458e-a33e-3f3f53e5d997-1000x560.jpg"
                            alt=" " data-slide-to="2" data-bs-slide-to="2">

                        <div class="carousel-caption">
                            <h5 class="mbr-section-subtitle mbr-fonts-style display-5"><strong>Colombo City
                                    Centre</strong></h5>
                            <p class="mbr-section-text mbr-fonts-style display-7">Colombo 02</p>
                        </div>
                    </div>
                </div>
                <div class="carousel-item slider-image item">
                    <div class="item-wrapper">
                        <img class="d-block w-100"
                            src="assets/images/d325c42a-7902-41c7-92d6-6879d5434365-1-800x600.jpg" alt=" "
                            data-slide-to="3" data-bs-slide-to="3">

                        <div class="carousel-caption">
                            <h5 class="mbr-section-subtitle mbr-fonts-style display-5"><strong>Liberty By Scope
                                    Cinemas&nbsp;</strong></h5>
                            <p class="mbr-section-text mbr-fonts-style display-7">Colpetty</p>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <section data-bs-version="5.1" class="gallery5 mbr-gallery cid-trv29xnf8c" id="gallery5-1m">
        ...
        <div class="container-fluid">
            <div class="mbr-section-head">
                <h3 class="mbr-section-title mbr-fonts-style align-center m-0 display-2"><strong>Locations</strong></h3>

            </div>
            <div class="row mbr-gallery mt-4">
                <div class="col-12 col-md-6 col-lg-6 item gallery-image">
                    <div class="item-wrapper" data-toggle="modal" data-bs-toggle="modal" data-target="#trxa2IKA5t-modal"
                        data-bs-target="#trxa2IKA5t-modal">
                        <img class="w-100" src="assets/images/17d0d2b3-02c3-4fe3-9c0d-8b16241480ae-1-1000x560.jpg"
                            alt="" data-slide-to="0" data-bs-slide-to="0" data-target="#lb-trxa2IKA5t"
                            data-bs-target="#lb-trxa2IKA5t">
                        <div class="icon-wrapper">
                            <span class="mobi-mbri mobi-mbri-search mbr-iconfont mbr-iconfont-btn"></span>
                        </div>
                    </div>
                    <h6 class="mbr-item-subtitle mbr-fonts-style align-center mb-2 mt-2 display-7"><strong>Liberty By
                            Scope Cinemas - Colpetty<br>3D Hall / Air Condition / Cafetaria / Car park / Snack Bar
                        </strong>
                        <div><a href="#maps" class="text-primary"><strong>View Location</strong></a></div>
                    </h6>
                </div>
                <div class="col-12 col-md-6 col-lg-6 item gallery-image">
                    <div class="item-wrapper" data-toggle="modal" data-bs-toggle="modal" data-target="#trxa2IKA5t-modal"
                        data-bs-target="#trxa2IKA5t-modal">
                        <img class="w-100" src="assets/images/image-1809x1206.jpg" alt="" data-slide-to="1"
                            data-bs-slide-to="1" data-target="#lb-trxa2IKA5t" data-bs-target="#lb-trxa2IKA5t">
                        <div class="icon-wrapper">
                            <span class="mobi-mbri mobi-mbri-search mbr-iconfont mbr-iconfont-btn"></span>
                        </div>
                    </div>
                    <h6 class="mbr-item-subtitle mbr-fonts-style align-center mb-2 mt-2 display-7"><strong>MAJESTIC CITY
                            ULTRA - COLOMBO 4<br>&nbsp;Barco DP2K 10S + GDC / Perlux 2D /Harkness Screen/ 7.1 JBL
                            Sound<br><a href="#maps" class="text-primary"><b>View Location</b></a></strong></h6>
                </div>
                <div class="col-12 col-md-6 col-lg-6 item gallery-image">
                    <div class="item-wrapper" data-toggle="modal" data-bs-toggle="modal" data-target="#trxa2IKA5t-modal"
                        data-bs-target="#trxa2IKA5t-modal">
                        <img class="w-100" src="assets/images/85472c6c-33ba-458e-a33e-3f3f53e5d997-1000x560.jpg" alt=""
                            data-slide-to="2" data-bs-slide-to="2" data-target="#lb-trxa2IKA5t"
                            data-bs-target="#lb-trxa2IKA5t">
                        <div class="icon-wrapper">
                            <span class="mobi-mbri mobi-mbri-search mbr-iconfont mbr-iconfont-btn"></span>
                        </div>
                    </div>
                    <h6 class="mbr-item-subtitle mbr-fonts-style align-center mb-2 mt-2 display-7"><strong>Colombo City
                            Centre<br>3D Hall / Air Condition / Cafetaria / Car park / Luxurious seats <br><a
                                href="#maps" class="text-primary"><b>View Location</b></a></strong></h6>
                </div>
                <div class="col-12 col-md-6 col-lg-6 item gallery-image">
                    <div class="item-wrapper" data-toggle="modal" data-bs-toggle="modal" data-target="#trxa2IKA5t-modal"
                        data-bs-target="#trxa2IKA5t-modal">
                        <img class="w-100" src="assets/images/7f3ad000-a850-43d8-81f6-af2520b2605a-1000x560.png" alt=""
                            data-slide-to="3" data-bs-slide-to="3" data-target="#lb-trxa2IKA5t"
                            data-bs-target="#lb-trxa2IKA5t">
                        <div class="icon-wrapper">
                            <span class="mobi-mbri mobi-mbri-search mbr-iconfont mbr-iconfont-btn"></span>
                        </div>
                    ...
                    <h6 class="mbr-item-subtitle mbr-fonts-style align-center mb-2 mt-2 display-7"><strong>Liberty By
                            Scope Cinemas - Kiribathgoda<br>3D Hall / Air Condition / Car park / Snack Bar<br><a
                                href="#maps" class="text-primary"><b>View Location</b></a></strong></h6>
                </div>
            </div>

            <div class="modal mbr-slider" tabindex="-1" role="dialog" aria-hidden="true" id="trxa2IKA5t-modal">
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        <div class="modal-body">
                            <div class="carousel slide carousel-fade" id="lb-trxa2IKA5t" data-ride="carousel"
                                data-bs-ride="carousel" data-interval="6000" data-bs-interval="6000">
                                <div class="carousel-inner">
                                    <div class="carousel-item active">
                                        <img class="d-block w-100"
                                            src="assets/images/17d0d2b3-02c3-4fe3-9c0d-8b16241480ae-1-1000x560.jpg"
                                            alt=" ">
                                    </div>
                                    <div class="carousel-item">
                                        <img class="d-block w-100" src="assets/images/image-1809x1206.jpg" alt=" ">
                                    </div>
                                    <div class="carousel-item">
                                        <img class="d-block w-100"
                                            src="assets/images/85472c6c-33ba-458e-a33e-3f3f53e5d997-1000x560.jpg"
                                            alt=" ">
                                    </div>
                                    <div class="carousel-item">
                                        <img class="d-block w-100"
                                            src="assets/images/7f3ad000-a850-43d8-81f6-af2520b2605a-1000x560.png"
                                            alt=" ">
                                    </div>
                                </div>
                                <ol class="carousel-indicators">
                                    <li data-slide-to="0" data-bs-slide-to="0" class="active"
                                        data-target="#lb-trxa2IKA5t" data-bs-target="#lb-trxa2IKA5t"></li>
                                    <li data-slide-to="1" data-bs-slide-to="1" class="" data-target="#lb-trxa2IKA5t"
                                        data-bs-target="#lb-trxa2IKA5t"></li>
                                    <li data-slide-to="2" data-bs-slide-to="2" data-target="#lb-trxa2IKA5t"
                                        data-bs-target="#lb-trxa2IKA5t"></li>
                                    <li data-slide-to="3" data-bs-slide-to="3" data-target="#lb-trxa2IKA5t"
                                        data-bs-target="#lb-trxa2IKA5t"></li>
                                ...
                                <a class="carousel-control-prev carousel-control" role="button" data-slide="prev"
                                    data-bs-slide="prev" href="#lb-trxa2IKA5t">
                                    <span class="mobi-mbri mobi-mbri-arrow-prev" aria-hidden="true"></span>
                                    <span class="sr-only visually-hidden">Previous</span>
                                </a>
                                <a class="carousel-control-next carousel-control" role="button" data-slide="next"
                                    data-bs-slide="next" href="#lb-trxa2IKA5t">
                                    <span class="mobi-mbri mobi-mbri-arrow-next" aria-hidden="true"></span>
                                    <span class="sr-only visually-hidden">Next</span>
                                </a>
                            </div>
    ...
    <section data-bs-version="5.1" class="map3 cid-trv19D604R" id="map3-1k">
        ...
        <div id="maps" class="container">
            <div class="row">
                <div class="col-12">
                    <h3 class="mbr-section-title mb-4 align-center mbr-fonts-style display-2"><strong>Get
                            Directions</strong><strong><br></strong></h3>
                </div>
                <div class="col-12 col-lg-6">
                    <h4 class="mbr-section-subtitle mb-3 align-center mbr-fonts-style display-5">Liberty By Scope
                        Cinemas - Colpetty</h4>
                    <div class="google-map"><iframe frameborder="0" style="border:0"
                            src="https://www.google.com/maps/embed/v1/place?key=AIzaSyDk89J4FSunMF33ruMVWJaJht_Ro0kvoXs&amp;q=Liberty By Scope Cinemas, 37A Srimath Anagarika Dharmapala Mawatha, Colombo 00700"
                            allowfullscreen=""></iframe></div>
                </div>
                <div class="col-12 col-lg-6">
                    <h4 class="mbr-section-subtitle mb-3 mt-5 mt-lg-0 align-center mbr-fonts-style display-5">MAJESTIC
                        CITY ULTRA CINEMAS</h4>
                    <div class="google-map"><iframe frameborder="0" style="border:0"
                            src="https://www.google.com/maps/embed/v1/place?key=AIzaSyDk89J4FSunMF33ruMVWJaJht_Ro0kvoXs&amp;q=Majestic City, 10 Station Rd, Colombo 00400"
                            allowfullscreen=""></iframe></div>
                </div>
            </div>
        </div>
    ...
    <section data-bs-version="5.1" class="map3 cid-trv9bEkIMg" id="map3-1r">
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-12 col-lg-6">
                    <h4 class="mbr-section-subtitle mb-3 align-center mbr-fonts-style display-5">Colombo City Centre
                    </h4>
                    <div class="google-map"><iframe frameborder="0" style="border:0"
                            src="https://www.google.com/maps/embed/v1/place?key=AIzaSyCNveGQ9bfpKFwWzQLLftrR9hNiHwdqQG8&amp;q=Colombo City Centre Mall and Residences, 137 Sir James Pieris Mawatha, Colombo 00200"
                            allowfullscreen=""></iframe></div>
                </div>
                <div class="col-12 col-lg-6">
                    <h4 class="mbr-section-subtitle mb-3 mt-5 mt-lg-0 align-center mbr-fonts-style display-5">Liberty By
                        Scope Cinemas - Kiribathgoda</h4>
                    <div class="google-map"><iframe frameborder="0" style="border:0"
                            src="https://www.google.com/maps/embed/v1/place?key=AIzaSyCNveGQ9bfpKFwWzQLLftrR9hNiHwdqQG8&amp;q=Liberty by Scope Cinemas - Kiribathgoda, Makola Road, Kiribathgoda"
                            allowfullscreen=""></iframe></div>
                </div>
            </div>
        </div>
    ...
    <section data-bs-version="5.1" class="mbr-section mbr-section--no-padding cid-truS5nyZKd" id="design-block-1e">



        <svg width="100%" height="50px" preserveAspectRatio="none" xmlns="http://www.w3.org/2000/svg"
    ...
    <section data-bs-version="5.1" class="footer3 cid-truEnFkGRK" once="footers" id="footer3-1c">
    ...
    <section data-bs-version="5.1" class="mbr-section cid-truS7sjDkC" id="design-block-1g">
        ...
        <div style="padding:1rem; background-color:#c1c1c1;" class="hidden">
            <div class="align-center">
                <br>Disable mouse right-click - This line is not published, it's only for ease of access to the blue
                gear<br>
    ...
    <section data-bs-version="5.1" class="_customHTML cid-truS6wNGox" id="design-block-1f">
