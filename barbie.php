...
<head>
    ...
    <link rel="shortcut icon" href="assets/img/3aij5sA5AhK2flrjsfrVQs93CUx.jpg" type="image/x-icon">
    <meta name="description" content="Barbie">


    <title>STORYTIME | BOOKING : Barbie</title>
...
<body>
    ...
    <section data-bs-version="5.1" class="header2 cid-tvxGt9 mbr-parallax-background" id="header2-2n">
        ...
        <div class="container">
            <div class="row">
                <div class="col-12 col-lg-7">
                    <h1 class="mbr-section-title mbr-fonts-style mb-3 display-1"><strong>Barbie</strong></h1>

                    <p class="mbr-text mbr-fonts-style display-7">Barbie and Ken are having the time of their lives in the colorful and seemingly perfect world of Barbie Land. However, when they get a chance to go to the real world, they soon discover the joys and perils of living among humans.</p>
                    <div class="mbr-section-btn mt-3"><a class="btn btn-secondary display-4"
                            href="">Book Now</a>
                        <a class="btn btn-primary-outline display-4"
                            href="https://www.youtube.com/watch?v=pBk4NYhWNMM">Trailer &gt;</a>
                    </div>
                </div>
            </div>
        </div>
